            ...
            >
              ...
              {submitted ? (
                <div className="p-8 rounded-xl bg-bio-green-light border border-bio-green/20 text-center">
                  ...
                  <h3 className="text-lg font-bold text-about-navy-head mb-1">Message Sent Successfully</h3>
                  <p className="text-sm text-about-text mb-4">
                    Thank you for reaching out to BioGen AI! Our computational biology team will review your inquiry and follow up within 2–3 business days.
                  </p>
                  <button 
                    type="button" 
                    onClick={() => {
          ...
          <div className="w-full lg:w-[45%] flex flex-col gap-6">
            ...
            >
              ...
              <div className="flex flex-col gap-8 relative z-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[15px] font-bold text-about-navy-head mb-1">GitHub</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[15px] font-bold text-about-navy-head mb-1">Discussions</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-[15px] font-bold text-about-navy-head mb-1">General Inquiries</h4>
            ...
            >
              ...
              <div>
                ...
                <a 
                  href="https://github.com/RosettaCommons/RFdiffusion/issues"
                  target="_blank"
