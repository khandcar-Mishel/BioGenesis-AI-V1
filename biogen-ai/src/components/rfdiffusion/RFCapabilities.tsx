        ...
        <div className="flex flex-row overflow-x-auto lg:overflow-visible gap-5 pb-4 lg:pb-0 hide-scrollbar snap-x">
          {capabilities.map((cap, index) => (
            <motion.div
              ...
              className="flex-1 min-w-[200px] bg-white border border-border-subtle rounded-[12px] p-5 snap-start transition-all duration-300 hover:border-border-color hover:-translate-y-1 hover:shadow-[0_4px_20px_rgba(16,24,40,0.04)]"
            >
