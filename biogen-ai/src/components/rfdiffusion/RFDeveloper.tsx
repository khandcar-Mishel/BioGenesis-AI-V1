        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start gap-8 flex-1">
            ...
            <div className="w-[120px] h-[140px] rounded-[12px] overflow-hidden bg-bio-deep shrink-0 relative flex items-end justify-center shadow-md">
              {/* Very minimal generic academic silhouette instead of a real scraped photo */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent z-10" />
              <svg viewBox="0 0 120 140" className="w-full h-full text-white/10 fill-current absolute bottom-0">
                <circle cx="60" cy="50" r="30" />
                <path d="M 10 140 Q 60 90 110 140" strokeWidth="0" />
              </svg>
              {/* Fallback pattern to make it look intentionally abstracted */}
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[length:4px_4px]" />
            </div>
