...
// Illustrative preview data; these are not outputs from a user job.
      ...
      <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
        ...
        <div className="mb-12 lg:mb-16">
          ...
          <p className="text-[15px] sm:text-[17px] text-md-text leading-[1.6] max-w-[680px]">
            Comprehensive analysis tools to evaluate the behavior and stability of your designed proteins. Charts show illustrative example data.
          </p>
        </div>
...
function HeatmapViz() {
    ...
    for(let r=0; r<rows; r++) {
        for(let c=0; c<cols; c++) {
            ...
            let type = r;
            if ((r * 17 + c * 31) % 100 > 85) type = (r + c) % 4;
